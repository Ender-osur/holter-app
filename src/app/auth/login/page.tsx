  ...
  return (
    <div className={`w-full flex justify-center items-center h-[100vh] ${styles.contain}`}>
      <main id="container-form" className={`bg-[#efffff] rounded-[20px] flex flex-col items-center ${styles.main}`}>
        ...
        >
          <h1 className='text-[48px] text-indigo-800 font-[700] tracking-[3px]'>Bienvenido/a</h1>
          
          <div className='h-[130px] w-[100%] p-5'>
          ...
          <div className='relative h-[130px] w-[100%] p-5'>
            ...
            <button
              type='button'
              className='h-[30px] w-[max-content] px-2 rounded-[15px] absolute right-6 bottom-[51px] bg-gray-200 text-gray-600 hover:bg-gray-300 focus:outline-none focus:bg-gray-300'
          ...
          <button
            type='submit'
            className='w-[200px] bg-indigo-700 text-white py-2 px-4 rounded-md hover:bg-indigo-800 focus:outline-none focus:bg-indigo-900'
          >
            Iniciar sesión
          </button>
        </form>
